  ...
  return (
    <div className="mt-8 flex flex-wrap items-center justify-between gap-3 border-t border-border pt-6">
      <button
        ...
        className="inline-flex items-center gap-2 rounded-lg border border-border bg-surface px-4 py-2.5 text-sm font-medium text-brand shadow-sm transition hover:bg-muted-bg disabled:pointer-events-none disabled:opacity-40"
      >

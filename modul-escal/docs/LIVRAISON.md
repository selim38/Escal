...
curl -sI https://escal.point-soft.fr/wc/v1.2.0/kre-configurateur.js | head -1
```
...
| Plugin WordPress | `deliverables/kre-configurateur-wp-1.2.0.zip` |
| URL staging | `https://escal.point-soft.fr/wc/staging/kre-configurateur.js` |
| URL production | `https://escal.point-soft.fr/wc/v1.2.0/kre-configurateur.js` |
